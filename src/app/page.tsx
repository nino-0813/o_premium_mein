    ...
    <div className="bg-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 sm:gap-16 items-center">
            ...
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <h2 className="font-serif text-xl sm:text-2xl md:text-3xl text-gray-900 mb-4 sm:mb-6 leading-tight break-keep">
      ...
      <section className="bg-brand-green py-14 sm:py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="font-serif text-xl sm:text-2xl md:text-3xl text-white mb-4 sm:mb-6 break-keep">まずは、その手でお確かめください。</h2>
